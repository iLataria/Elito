...
namespace NutakuUnitySdk
{
    ...
    public static class NutakuSdkConfig
    {
        ...
        public static int RuntimeVersionCodeFromManifest = 34; // You MUST remember to update this field value everytime you prepare a new build for the platform!
        ...
        public static string TitleId = "nutaku2-test"; // the TITLE ID of your game from the CMS

        public static string AndroidPackageName = "com.silverfoxlab.sexybeaches2"; // must match what is in your manifest, otherwise browser events like logins or payments won't be captured by the game
